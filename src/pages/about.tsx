                    ...
                    <div className={`${pageLoad ? 'animate-fade-in-bottom' : 'opacity-0'} w-1/2 mx-auto pt-8`}>
                        ...
                        >
                            ...
                            <p className="font-leaguespartan text-center text-xl text-text mb-2">
                                Hey, I&apos;m Amar Bajraktarevic, a 16-year-old high school student from Michigan who&apos;s passionate about coding. It all started when I was younger, looking at websites people had made and thinking, &quot;I want to make something like that too!&quot; So, I taught myself how to code.
                                By sophomore year, I was fully immersed, working on a website for a business idea my friend and I came up with. Now, I&apos;ve got several websites up and running, all thanks to my love for coding. Feel free to check them all out!
                            </p>
